...
def simpleTest():
    ...
    #net.addController( 'c0', controller=RemoteController, ip='10.1.50.176', port=6653 )
    net = Mininet(topo=topo, host=CPULimitedHost, link=TCLink, controller=partial(RemoteController, ip='10.1.50.176', port=6653))
    net.start()
